                    ...
                    <div class="card shadow mt-3">
                        <div class="card-body  p-5">
                            <div class="container ">
                                ...
                                <form action="<?=base_url('banner-store')?>" method="post" enctype="multipart/form-data">                              
                                   
                                <div class="form-group">
                                        <label for="offer_banner">Choose Image:</label>
                                        <input type="file" class="form-control-file" id="imageUpload" name="prod_offer" accept="image/*">
                                        
                                    </div>

                                    <button type="submit" name="add_banner" class="btn btn-primary">Upload Image</button>
