        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if (count($product) == 1) {
                ...
                if ($CartModel->update($Id, $updateddata)) {
                    ...
                    $returnarr = array('status' => 'success', 'Qyt' => $oldQyt + 1, 'count' => $allcount, 'totalItemPrice' => $totalItemPrice);
                } else {
                    echo 9;
                }
            } else {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if ($oldQyt == 1) {
                ...
                if ($CartModel->update($Id, $updateddata)) {
                    ...
                    $returnarr = array('status' => 'success', 'Qyt' => $oldQyt - 1, 'totalItemPrice' => $totalItemPrice);
                } else {
                }
            }
            echo json_encode($returnarr);
    ...
    public function removeItem()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if ($CartModel->where('Id', $cartID)->delete()) {
                ...
                $returnarr = array('status' => 'success', 'totalItemPrice' => $totalItemPrice);
            } else {
            }
            echo json_encode($returnarr);
        }
